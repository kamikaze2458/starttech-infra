...
resource "aws_s3_bucket" "frontend" {
  ...
  tags   = { Name = "much-to-do-frontend-${var.environment}" }
}
...
resource "aws_cloudfront_origin_access_control" "frontend" {
  name                              = "much-to-do-oac-${var.environment}"
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  comment             = "Much-To-Do frontend – ${var.environment}"
  ...
  tags = { Name = "much-to-do-cf-${var.environment}" }
}
